...
import { TripProvider } from "@/lib/trip-state";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "SafePath AI" },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/safepath-icon.svg" },
    ],
  }),
...
function AuthGate({ children }: { children: ReactNode }) {
  ...
  const publicPath = pathname === "/login" || pathname === "/signup" || pathname === "/forgot-password" || pathname === "/update-password";
  const isPasswordRecovery = pathname === "/update-password";

  useEffect(() => {
    if (!loading && !session && !publicPath) void navigate({ to: "/login", replace: true });
